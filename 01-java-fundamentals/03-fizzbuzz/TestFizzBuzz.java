public class TestFizzBuzz {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(tester.fizzBuzz(9,"three", "five", "three five"));
        System.out.println(tester.fizzBuzz(10,"three", "five", "three five"));
        System.out.println(tester.fizzBuzz(15,"three", "five", "three five"));
        System.out.println(tester.fizzBuzz(16,"three", "five", "three five"));
        System.out.println(tester.fizzBuzz(2,"three", "five", "three five"));

        // for (int i = 1; i <= 50; i++) {
        //     System.out.println(tester.fizzBuzz(i, "three", "five", "three five"));
        // }
    }
}
