public class AlfredTest {
    ...
    */
    public static void main(String[] args) {
        ...
        String playRock = alfredBot.playMusic("Rock");
        String playPop = alfredBot.playMusic("Pop");
        String playCountry = alfredBot.playMusic("Country");
        ...
        System.out.println(playRock);
        System.out.println(playPop);
        System.out.println(playCountry);
    }
}
